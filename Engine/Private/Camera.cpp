...
CCamera::CCamera(const CGameObject& rhs)
	:CGameObject(rhs)
{
}
...
{
	m_pGameInstance->Set_ViewMatrix(m_pTransformCom->Get_WorldMatrix_Inverse());
	m_pGameInstance->Set_ProjMatrix(XMMatrixPerspectiveFovLH(m_fFovy, m_fAspect, m_fNear, m_fFar));
