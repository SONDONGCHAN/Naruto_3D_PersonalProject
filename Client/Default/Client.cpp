...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance,
    ...
    //if (LOWORD(msg.wParam) == WM_ACTIVATE)
    //{
    RECT clientRect;
    GetClientRect(g_hWnd, &clientRect);
    
    // 클라이언트 영역을 스크린 좌표로 변환
    ClientToScreen(g_hWnd, (LPPOINT)&clientRect.left);
    ClientToScreen(g_hWnd, (LPPOINT)&clientRect.right);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hCursor = LoadCursor(nullptr, IDC_SIZE);
    ShowCursor(FALSE);
