...
HRESULT CMainApp::Ready_Make_Texture()
{
	//////////////////////////////////////

	/*_ulong		dwByte = { 0 };
	HANDLE		hFile = CreateFile(TEXT("../Bin/DataFiles/Navi_KonohaVillage_Robby.dat"), GENERIC_WRITE, 0, nullptr, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, 0);
	if (0 == hFile)
		return E_FAIL;
