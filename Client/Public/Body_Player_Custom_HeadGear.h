...
class CBody_Player_Custom_HeadGear : public CPartObject
{
public:
...
private:
	CBody_Player_Custom_HeadGear(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CBody_Player_Custom_HeadGear(const CBody_Player_Custom_HeadGear& rhs);
	virtual ~CBody_Player_Custom_HeadGear() = default;
...
private:
	...
	vector<CModel*> m_HeadGearModels;
...
public:
	static CBody_Player_Custom_HeadGear*	Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
