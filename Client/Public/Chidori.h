...
class CChidori : public CSkill
{
public:
	enum CHIDORI_STATE { STATE_MAKING, STATE_DETECTING, STATE_FINISH, STATE_END };

	struct SKILL_CHIDORI_DESC : public  CSkill::SKILL_DESC
	{
		_float4x4* pSocketMatrix;
	};

private:
	CChidori(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
