...
class CBody_Player_Custom_Lower : public CPartObject
{
public:
...
private:
	CBody_Player_Custom_Lower(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CBody_Player_Custom_Lower(const CBody_Player_Custom_Lower& rhs);
	virtual ~CBody_Player_Custom_Lower() = default;
...
public:
	static CBody_Player_Custom_Lower*	Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
