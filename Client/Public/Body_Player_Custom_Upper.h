...
class CBody_Player_Custom_Upper : public CPartObject
{
public:
...
private:
	CBody_Player_Custom_Upper(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CBody_Player_Custom_Upper(const CBody_Player_Custom_Upper& rhs);
	virtual ~CBody_Player_Custom_Upper() = default;
...
public:
	static CBody_Player_Custom_Upper*	Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
